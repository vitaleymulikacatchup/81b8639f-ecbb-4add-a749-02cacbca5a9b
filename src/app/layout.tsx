...
export const metadata: Metadata = {
  title: "Child Life - Premium Toys & Play for Happy Kids",
  description: "Discover carefully curated toys for children of all ages. Safe, educational, and fun toys that spark imagination and joy. Shop quality toys at Child Life today.",
  keywords: "toys, children toys, educational toys, safe toys, toy store, kids toys, play toys, family shopping",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Child Life - Toys That Inspire Joy",
    description: "Carefully curated toys designed to spark creativity and joy in children of all ages.",
    type: "website",
    siteName: "Child Life",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765908724508-kmwtlur8.jpg",
      alt: "Child Life Toys - Inspiring Joy Through Play"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Child Life - Premium Toys for Kids",
    description: "Discover safe, educational, and engaging toys for your family.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765908724508-kmwtlur8.jpg"]
  }
};
